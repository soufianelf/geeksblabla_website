      ...
      <div className="container">
        <div className="item reverse">
          <div>
            <h1> MSS Videos </h1>
            <p>
              In Moroccan Success Story videos, we invite a Moroccan icon in the
              IT and related fields, to share their experiences, lessons learned
              and knowledge with the Moroccan community.
            </p>
          </div>
